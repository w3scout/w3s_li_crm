...
$GLOBALS['TL_LANG']['MOD']['li_customers'] = array('Customers', 'Manage customers.');
$GLOBALS['TL_LANG']['MOD']['li_products'] = array('Products', 'Manage products.');
$GLOBALS['TL_LANG']['MOD']['li_tasks'] = array('Tasks', 'Manage tasks.');
$GLOBALS['TL_LANG']['MOD']['li_appointments'] = array('Appointments', 'Manage appointments.');
