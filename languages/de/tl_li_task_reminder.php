...
$GLOBALS['TL_LANG']['tl_li_task_reminder']['toTask'] = array("Aufgabe", "Bitte wählen Sie die Aufgabe aus. (Aufgaben, deren Deadline verstrichen ist, werden nicht angezeigt!)");
...
$GLOBALS['TL_LANG']['tl_li_task_reminder']['new'] = array("Neue Erinnerung", "Eine neue Erinnerung erstellen");
...
$GLOBALS['TL_LANG']['tl_li_task_reminder']['show'] = array("Erinnerung anzeigen", "Die Erinnerung mit der ID %s anzeigen");
