 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_li_service']['new']    = array('Neue Leistung', 'Ein neue Leistung anlegen');
$GLOBALS['TL_LANG']['tl_li_service']['show']   = array('Leistungsdetails', 'Details der Leistung ID %s anzeigen');
$GLOBALS['TL_LANG']['tl_li_service']['edit']   = array('Leistung bearbeiten', 'Leistung ID %s bearbeiten');
$GLOBALS['TL_LANG']['tl_li_service']['copy']   = array('Leistung duplizieren', 'Leistung ID %s duplizieren');
$GLOBALS['TL_LANG']['tl_li_service']['delete'] = array('Leistung löschen', 'Leistung ID %s löschen');
