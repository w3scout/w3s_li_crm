...
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['new'] = array('Neue Erinnerung', 'Eine neue Erinnerung erstellen');
...
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['show'] = array('Erinnerung anzeigen', 'Die Erinnerung mit der ID %s anzeigen');
