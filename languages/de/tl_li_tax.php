...
$GLOBALS['TL_LANG']['tl_li_tax']['copy'] = array('Steuersatz duplizieren', 'Den Steuersatz mit der ID %s duplizieren');
$GLOBALS['TL_LANG']['tl_li_tax']['delete'] = array('Steuersatz löschen', 'Den Steuersatz mit der ID %s löschen');
$GLOBALS['TL_LANG']['tl_li_tax']['show'] = array('Steuersatz anzeigen', 'Den Steuersatz mit der ID %s anzeigen');