...
class Task extends \BackendModule
{
    ...
    public function renderLabel($row, $label)
    {
         ...
         */
        $this->import('LiCRM\TaskComment', 'TaskComment');
     ...
     * @return string
     */
    public function commentTaskIcon($row, $href, $label, $title, $icon, $attributes)
    {
