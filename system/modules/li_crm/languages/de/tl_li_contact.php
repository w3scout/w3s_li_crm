...
$GLOBALS['TL_LANG']['tl_li_contact']['edit'] = array("Kontakt bearbeiten", "Den Kontakt mit der ID %s bearbeiten");
$GLOBALS['TL_LANG']['tl_li_contact']['copy'] = array("Kontakt duplizieren", "Den Kontakt mit der ID %s duplizieren");
$GLOBALS['TL_LANG']['tl_li_contact']['delete'] = array("Kontakt löschen", "Den Kontakt mit der ID %s löschen");
$GLOBALS['TL_LANG']['tl_li_contact']['show'] = array("Kontakt anzeigen", "Den Kontakt mit der ID %s anzeigen");
