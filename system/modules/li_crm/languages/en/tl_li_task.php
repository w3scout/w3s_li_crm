...
$GLOBALS['TL_LANG']['tl_li_task']['toStatus'] = array("Status", "Please choose the status of the task.");
$GLOBALS['TL_LANG']['tl_li_task']['toUser'] = array("Assigned to", "Please choose a user that this task is assigned to.");
$GLOBALS['TL_LANG']['tl_li_task']['priority'] = array("Priority", "Please choose a priority.");
$GLOBALS['TL_LANG']['tl_li_task']['title'] = array("Title", "Please enter a title.");
...
$GLOBALS['TL_LANG']['tl_li_task']['more_comments'] = 'show more comments';
