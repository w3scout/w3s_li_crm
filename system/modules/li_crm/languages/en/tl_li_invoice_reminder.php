...
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['toInvoice'] = array("Invoice", "Please choose an invoice.");
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['remindOnce'] = array("Remind once", "Create a single reminder.");
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['remindDate'] = array("Remind date", "Please choose a date when the reminder should be sent.");
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['remindRepeatedly'] = array("Remind repeatedly", "Create a repeated reminder.");
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['remindInterval'] = array("Interval", "Please choose an interval.");
...
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['text'] = "Invoice reminder for invoice \"%s\" form %s.";
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['customerRemark'] = "The invoce is for \"%s %s\".";
...
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['copy'] = array("Duplicate reminder", "Duplicate the reminder with the ID %s");
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['delete'] = array("Delete reminder", "Delete the reminder with the ID %s");
$GLOBALS['TL_LANG']['tl_li_invoice_reminder']['show'] = array("Show reminder", "Show the reminder with the ID %s");
