...
(
	...
	(
		...
		'default'                     => '{invoice_legend},toCustomer,toCategory,title,alias,invoiceDate,performanceDate,price,currency;{pdf_legend},file;{settings_legend},isOut,isSingular;{generation_legend},enableGeneration;'
	),
