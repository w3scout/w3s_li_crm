...
(
	...
	(
		...
		'default'         => '{settings_legend:hide},changeCustomerProject,changePriority,changeTitle,changeDeadline;{comment_legend},toStatus,toUser,comment;{timekeeping_legend},keeptime;{history_legend},history'
	),
	'subpalettes' => array
	(
	...
	(
		...
		(
			...
			'inputType'			=> 'liplexCrmTaskHistory'
		)
	)
);
